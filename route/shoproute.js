...
const imageUpload = require('../middleware/shopmiddleware')
const {getAllProducts, addNewProduct, getFileByName} = require('../controller/productControl')
const {addProductsToCart, getAllCartItems, getCartTotal, checkOutCart} = require('../controller/cartControl')
